 ...
 * @author system
 * @version 1.0
 * @see com.xuanjiao.infrastructure.dataobject.WorkflowStageDO
 */
@Data
public class WorkflowStage {
    ...
    /** 关联的工作流定义ID，指向Workflow */
    private Long workflowId;

    /** 阶段名称，如"部门审批"、"领导审批"、"综合审批"等 */
    private String name;

    /** 阶段排序序号，决定阶段的执行顺序，数值越小越先执行 */
    private Integer stageOrder;

    /** 审批类型：AND-会签（所有审批人需同意）、OR-或签（任一审批人同意即可） */
    private String approveType;

    /** 阶段审批人列表，定义该阶段有哪些审批人/审批角色 */
