...
public class AssetServiceImplTest {
    ...
    public void testGetMyApprovedAssets_WithFilters() {
        ...
        PageResult<AssetDTO> result = assetService.getMyApprovedAssets("测试", "IMAGE", 1, 10, 1L);
    ...
    public void testGetMyApprovedAssets_NoFilters() {
        ...
        PageResult<AssetDTO> result = assetService.getMyApprovedAssets(null, null, 1, 10, 1L);
